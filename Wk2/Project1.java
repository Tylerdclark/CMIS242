...
class Project1{
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* 
        Initialization of a bunch of stuff I need. I am only using an
        ArrayList temporarily because of the .add method and no fixed size
        */
            ...
            try {
                ...
                if(file.isFile()){
                    ...
                    while(fileIn.hasNextLine()){
                        ...
                        int tempLb = fileIn.nextInt();
                        double temptOz = fileIn.nextDouble();
                        Weight tempW = new Weight(tempLb,temptOz);
    ...
    /* 
    takes in the array of weight objects and loops through using the
    Weight class lessThan() to determine the smallest. Makes sense why we made it...
    */
    ...
    private static Weight findAverage(Weight[] w){
        Weight totalWeight = new Weight(0, 0);
